...
async function transferBGPTokens(toWallet, amount) {
    try {
        ...
        // 6. Asegurar que la cuenta destino existe
        ...
        // 9. Crear instrucción de transferencia
